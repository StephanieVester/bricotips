 ...
 */
class Bloc_Image_Titre_Widget extends WP_Widget
{
    ...
    {
        parent::__construct(
            'bloc_image_titre_widget', // Base ID
            'Widget Bloc Image Titre', // Name
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($urlImage)) {
?>
            <div class="bloc-image-titre" style="background-image: url(<?= $urlImage ?>)">
                <p class="titre">
                    <a href="<?= $urlLink ?>" class="bloc-image-link"><?= $title ?></a>
                </p>
            </div>
        <?php
        } else {
        ?>
            <div class="bloc-image-titre">
                <p class="titre">
                    <a href="<?= $urlLink ?>" class="bloc-image-link"><?= $title ?></a>
                </p>
            </div>
    ...
    public function form($instance)
    {
        ...
        $urlLink = isset($instance['url_link']) ? $instance['url_link'] : '';
        ?>
        <p>
        ...
        <p>
            <label for="<?php echo $this->get_field_name('url_link'); ?>">Lien</label>
