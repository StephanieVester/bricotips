...
<main id="apropos">
    ...
    <?php
    echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost/bricotips/wp-content/uploads/2023/07/banniere-image.webp"]');
    ?>
    ...
    <section id="quisuisje">
        ...
        <div class="image">
            <img src="<?= get_stylesheet_directory_uri() . '/images/autor.jpg'; ?>" alt="un bonhomme bricoleur">
        </div>
    </section>
    <section id="bricolage">
        <h2>Notre passion commune</h2>
        <div class="image">
            <img src="<?= get_stylesheet_directory_uri() . '/images/brico.jpg'; ?>" alt="des bonhommes qui peignent des murs de différentes couleurs">
        </div>
        <div class="text">
